...
public class Executioner_EnragedState : StateMachineBehaviour
{
    public float speed;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        } else if (Vector2.Distance(player.position, rb.position) > attackRange && Vector2.Distance(player.position, rb.position) < abilityRange) {
